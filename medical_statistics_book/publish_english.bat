...
set SRC=export\book\community_medicine_cbme.md
set OUTDIR=export\book
set DOCX=%OUTDIR%\community_medicine_cbme.docx
set HTML=%OUTDIR%\community_medicine_cbme.html
set PDF=%OUTDIR%\community_medicine_cbme.pdf
